...
Public Class For_CantidadRecaudo
    ...
    Sub CargarCombos()
        ...
        dv1.RowFilter = String.Format("ID=1 OR ID=2")
    ...
    Private Sub BtnTarifas_Click(sender As Object, e As EventArgs) Handles BtnTarifas.Click
        ...
        Cliente.Codigo = For_DespachoMercancia.TxtCodCliente.Text
        Cliente.Cliente = For_DespachoMercancia.LblNombreCliente.Text
    ...
    Private Sub CmbServicios_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles CmbServicios.SelectionChangeCommitted
        ...
        Consulta1 = Descargue.ValoresDescargue(For_DespachoMercancia.CmbCentros.SelectedValue, For_DespachoMercancia.CmbBodegas.SelectedValue, For_DespachoMercancia.TxtCodCliente.Text, CmbServicios.SelectedValue)
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        ...
        For_DespachoMercancia.DGTarifasServicios.Rows.Clear()
        ...
        With DGTarifasServicios
            ...
            For I = 0 To .Rows.Count - 1
                For_DespachoMercancia.DGTarifasServicios.Rows.Add(Trim(.Rows(I).Cells(0).Value),
            ...
            For_DespachoMercancia.TxtValorTotal.Text = TxtTotalServicio.Text
